...
export default function Usuario() {
  ...
  async function fetchData() {
    try {
      ...
      // Substitua "temperatura" pelo nome real do campo no seu banco de dados
      const temperatura = response.data.resultado[0].temperatura;

      // Você pode adicionar lógica para verificar o valor de "temperatura" e exibir a imagem apropriada.
      const showAlertButton = temperatura > 20 ? 0 : 2;

      setData({ temperatura, showAlertButton });
    } catch (error) {
      console.log(error);
    }
  }
